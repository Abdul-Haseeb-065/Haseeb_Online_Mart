...
from app.curd.stock_curd import (update_product_stock, get_stock_level, get_all_products_stock, get_specific_product_stock) # type: ignore
from app.models.stock_model import Stock # type: ignore

inventory_router = APIRouter()

@inventory_router.put("/inventory_update", response_model=Stock)
...
@inventory_router.get("/get_stock_level", response_model=dict)
...
@inventory_router.get("/get_specific_product_stock", response_model=dict)
...
@inventory_router.get("/get_all_products_stock", response_model=list[dict])
