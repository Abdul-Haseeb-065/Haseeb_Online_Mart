...
from app.curd import user_notification, order_notification, payment_notification

async def get_kafka_consumer(*topics: Union[str, List[str]]):
    consumer_kafka = AIOKafkaConsumer(*topics, bootstrap_servers=["broker:19092"], auto_offset_reset="earliest")
